...
for i in letter:
	for j in letter:
		for k in letter:
			#print(sha256((i+j+k).encode("utf-8")).hexdigest())
			if (sha256((i+j+k).encode("utf-8")).hexdigest())== '4d416525fcdbdd87be5b3cda134e806dfa6613c682fb8b749ea552adeffab251' :
				print ("This is the answer" + i + j + k)
